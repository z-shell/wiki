var AsciinemaPlayer = (function (A) {
  ...
  !(function (A) {
    var g = (function (A) {
      ...
      function i(A, g, I) {
        return Object.defineProperty(A, g, {value: I, enumerable: !0, configurable: !0, writable: !0}), A[g];
      }
      try {
        i({}, '');
      } catch (A) {
          ...
          (C._invoke = (function (A, g, I) {
            ...
            return function (Q, C) {
              ...
              for (I.method = Q, I.arg = C; ; ) {
                ...
                'throw' === i.type && ((B = a), (I.method = 'throw'), (I.arg = i.arg));
              }
            };
          })(A, I, E)),
          C
      ...
      var f = (D.prototype = w.prototype = Object.create(h));
      function G(A) {
      ...
      function N(A, I) {
        ...
        if (B === g) {
          if (((I.delegate = null), 'throw' === I.method)) {
            if (A.iterator.return && ((I.method = 'return'), (I.arg = g), N(A, I), 'throw' === I.method)) return c;
            (I.method = 'throw'), (I.arg = new TypeError("The iterator does not provide a 'throw' method"));
          }
          return c;
        }
        var Q = n(B, A.iterator, I.arg);
        if ('throw' === Q.type) return (I.method = 'throw'), (I.arg = Q.arg), (I.delegate = null), c;
        var C = Q.arg;
        return C
          ? C.done
            ? ((I[A.resultName] = C.value),
              ...
              c)
            : C
          : ((I.method = 'throw'), (I.arg = new TypeError('iterator result is not an object')), (I.delegate = null), c);
      }
      function M(A) {
        var g = {tryLoc: A[0]};
        1 in A && (g.catchLoc = A[1]), 2 in A && ((g.finallyLoc = A[2]), (g.afterLoc = A[3])), this.tryEntries.push(g);
      }
      function F(A) {
        var g = A.completion || {};
      ...
      function R(A) {
        if (A) {
          ...
          if (!isNaN(A.length)) {
            var Q = -1,
              E = function I() {
                for (; ++Q < A.length; ) if (B.call(A, Q)) return (I.value = A[Q]), (I.done = !1), I;
      ...
      return (
        ...
        (A.isGeneratorFunction = function (A) {
          ...
          return !!g && (g === u || 'GeneratorFunction' === (g.displayName || g.name));
        }),
        (A.mark = function (A) {
          return (
            Object.setPrototypeOf ? Object.setPrototypeOf(A, D) : ((A.__proto__ = D), i(A, t, 'GeneratorFunction')),
        ...
        (d.prototype = {
          ...
          reset: function (A) {
            if (
              ...
              for (var I in this) 't' === I.charAt(0) && B.call(this, I) && !isNaN(+I.slice(1)) && (this[I] = g);
          },
          stop: function () {
            this.done = !0;
          ...
          dispatchException: function (A) {
            ...
            var I = this;
            function Q(B, Q) {
              return (t.type = 'throw'), (t.arg = A), (I.next = B), Q && ((I.method = 'next'), (I.arg = g)), !!Q;
            }
          ...
          abrupt: function (A, g) {
            ...
            return (
              (E.type = A), (E.arg = g), C ? ((this.method = 'next'), (this.next = C.finallyLoc), c) : this.complete(E)
            );
          },
          ...
          delegateYield: function (A, I, B) {
            return (
              (this.delegate = {iterator: R(A), resultName: I, nextLoc: B}), 'next' === this.method && (this.arg = g), c
            );
          },
        }),
        A
  ...
  function n(A, g) {
    return (
      ...
      (function (A, g) {
        ...
        if (null != I) {
          var B,
            ...
            t = !1;
          try {
            for (I = I.call(A); !(E = (B = I.next()).done) && (C.push(B.value), !g || C.length !== g); E = !0);
          } catch (A) {
            (t = !0), (Q = A);
          } finally {
            try {
      ...
      (function (A, g) {
        if (A) {
          if ('string' == typeof A) return e(A, g);
  ...
  function G(A, g) {
    ...
    const I = {value: A, observers: null, observerSlots: null, pending: a, comparator: g.equals || void 0};
    return [Y.bind(I), (A) => ('function' == typeof A && (A = A(I.pending !== a ? I.pending : I.value)), S(I, A))];
  }
  function k(A, g, I) {
    v(U(A, g, !1, 1));
  }
  ...
  function p(A) {
    return null === w || (null === w.cleanups ? (w.cleanups = [A]) : w.cleanups.push(A)), A;
  }
  function J() {
    return u;
  }
  ...
  function Y() {
    if (this.sources && this.state) {
      const A = h;
      (h = null), 1 === this.state ? v(this) : H(this), (h = A);
    }
    if (u) {
      const A = this.observers ? this.observers.length : 0;
      u.sources ? (u.sources.push(this), u.sourceSlots.push(A)) : ((u.sources = [this]), (u.sourceSlots = [A])),
        this.observers
          ? (this.observers.push(u), this.observerSlots.push(u.sources.length - 1))
          : ((this.observers = [u]), (this.observerSlots = [u.sources.length - 1]));
    }
    return this.value;
  }
  function S(A, g, I) {
  ...
  function U(A, g, I, B = 1, Q) {
    ...
    return null === w || (w !== c && (w.owned ? w.owned.push(C) : (w.owned = [C]))), C;
  }
  function K(A) {
    if (0 === A.state) return;
    if (2 === A.state) return H(A);
    if (A.suspense && d(A.suspense.inFallback)) return A.suspense.effects.push(A);
    const g = [A];
  ...
  function H(A, g) {
    ...
    for (let I = 0; I < A.sources.length; I += 1) {
      const B = A.sources[I];
      B.sources && (1 === B.state ? B !== g && K(B) : 2 === B.state && H(B, g));
    }
  }
  function x(A) {
    for (let g = 0; g < A.observers.length; g += 1) {
  ...
  function W(A) {
    if ('function' == typeof A && !A.length) return W(A());
    if (Array.isArray(A)) {
      const g = [];
          ...
          () => {
            ...
            return d(() => {
              let A,
                ...
                h = n.length;
              if (0 === h)
                0 !== E && (X(C), (C = []), (B = []), (Q = []), (E = 0), t && (t = [])),
                  I.fallback && ((B = [T]), (Q[0] = f((A) => ((C[0] = A), I.fallback()))), (E = 1));
              else if (0 === E) {
                for (Q = new Array(h), e = 0; e < h; e++) (B[e] = n[e]), (Q[e] = f(o));
                E = h;
              } else {
                for (
                  r = new Array(h), s = new Array(h), t && (a = new Array(h)), c = 0, w = Math.min(E, h);
                  c < w && B[c] === n[c];
                  c++
                );
                for (w = E - 1, u = h - 1; w >= c && u >= c && B[w] === n[u]; w--, u--)
                  (r[u] = Q[w]), (s[u] = C[w]), t && (a[u] = t[w]);
                for (A = new Map(), g = new Array(u + 1), e = u; e >= c; e--)
                  (D = n[e]), (i = A.get(D)), (g[e] = void 0 === i ? -1 : i), A.set(D, e);
                for (i = c; i <= w; i++)
                  (D = B[i]),
                    (e = A.get(D)),
                    void 0 !== e && -1 !== e
                      ? ((r[e] = Q[i]), (s[e] = C[i]), t && (a[e] = t[i]), (e = g[e]), A.set(D, e))
                      : C[i]();
                for (e = c; e < h; e++)
                  e in r ? ((Q[e] = r[e]), (C[e] = s[e]), t && ((t[e] = a[e]), t[e](e))) : (Q[e] = f(o));
          ...
          () => {
            ...
            return d(() => {
              if (0 === e.length)
                return (
                  0 !== i && (X(E), (E = []), (Q = []), (C = []), (i = 0), (t = [])),
                  I.fallback && ((Q = [T]), (C[0] = f((A) => ((E[0] = A), I.fallback()))), (i = 1)),
                  C
                );
              for (Q[0] === T && (E[0](), (E = []), (Q = []), (C = []), (i = 0)), B = 0; B < e.length; B++)
                B < Q.length && Q[B] !== e[B] ? t[B](() => e[B]) : B >= Q.length && (C[B] = f(n));
              for (; B < Q.length; B++) E[B]();
              return (i = t.length = E.length = e.length), (Q = e.slice(0)), (C = C.slice(0, i));
            });
            function n(A) {
              E[B] = A;
              const [I, Q] = G(e[B]);
  ...
  function V(A) {
    let g = !1;
    const I = M(() => A.when, void 0, {equals: (A, I) => (g ? A === I : !A == !I)});
    return M(() => {
      const B = I();
      if (B) {
        const I = A.children;
        return (g = 'function' == typeof I && I.length > 0) ? d(() => I(B)) : I;
      }
      return A.fallback;
    });
  }
  function _(A) {
    ...
    return M(() => {
      ...
      const E = C.children;
      return (g = 'function' == typeof E && E.length > 0) ? d(() => E(Q)) : E;
    });
  }
  function $(A) {
    return A;
  ...
  function BA(A, g = window.document) {
    ...
    for (let B = 0, Q = A.length; B < Q; B++) {
      const Q = A[B];
      I.has(Q) || (I.add(Q), g.addEventListener(Q, iA));
    }
  }
  function QA(A, g, I, B) {
    B
  ...
  function CA(A, g, I = {}) {
    ...
    let Q, C;
    for (C in ('string' == typeof I && (I = {}), I)) null == g[C] && B.removeProperty(C), delete I[C];
  ...
  function eA(A, g, I, B, Q) {
    ...
    if (((A = (E && I[0] && I[0].parentNode) || A), 'string' === C || 'number' === C))
      if (('number' === C && (g = g.toString()), E)) {
        let Q = I[0];
        Q && 3 === Q.nodeType ? (Q.data = g) : (Q = document.createTextNode(g)), (I = rA(A, I, B, Q));
      } else I = '' !== I && 'string' == typeof I ? (A.firstChild.data = g) : (A.textContent = g);
    else if (null == g || 'boolean' === C) I = rA(A, I, B);
    else {
      if ('function' === C)
        return (
          k(() => {
      ...
      if (Array.isArray(g)) {
        const C = [];
        if (nA(C, g, Q)) return k(() => (I = eA(A, C, I, B, !0))), () => I;
        if (0 === C.length) {
          if (((I = rA(A, I, B)), E)) return I;
        } else
          Array.isArray(I)
            ? 0 === I.length
              ? oA(A, C, B)
              : (function (A, g, I) {
                  ...
                  for (; E < Q || t < C; )
                    if (g[E] !== I[t]) {
                      ...
                      } else if (C === t) for (; E < Q; ) (e && e.has(g[E])) || g[E].remove(), E++;
                      else if (g[E] === I[C - 1] && I[t] === g[Q - 1]) {
                        const B = g[--Q].nextSibling;
                        A.insertBefore(I[t++], g[E++].nextSibling), A.insertBefore(I[--C], B), (g[Q] = I[C]);
                      } else {
                        if (!e) {
                          e = new Map();
                          let A = t;
                        ...
                        if (null != B)
                          if (t < B && B < C) {
                            let i,
                              n = E,
                              o = 1;
                            for (; ++n < Q && n < C && null != (i = e.get(g[n])) && i === B + o; ) o++;
                            if (o > B - t) {
                              const Q = g[E];
        ...
        if (Array.isArray(I)) {
          if (E) return (I = rA(A, I, B, g));
          rA(A, I, null, g);
        } else null != I && '' !== I && A.firstChild ? A.replaceChild(g, A.firstChild) : A.appendChild(g);
        I = g;
      }
    }
    return I;
  ...
  function DA(A) {
    wA === aA.length && aA.push(aA.length + 1);
    var g = wA;
    return (wA = aA[g]), (aA[g] = A), g;
  }
  var hA = new TextDecoder('utf-8', {ignoreBOM: !0, fatal: !0});
  hA.decode();
  var lA = null;
  function yA() {
    return (null !== lA && lA.buffer === sA.memory.buffer) || (lA = new Uint8Array(sA.memory.buffer)), lA;
  }
  function fA(A, g) {
    return hA.decode(yA().subarray(A, A + g));
  }
  function GA(A) {
    var g = i(A);
    ...
    if (Array.isArray(A)) {
      var Q = A.length,
        C = '[';
      Q > 0 && (C += GA(A[0]));
      for (var E = 1; E < Q; E++) C += ', ' + GA(A[E]);
      return (C += ']');
    }
    var t,
      e = /\[object ([^\]]+)\]/.exec(toString.call(A));
    if (!(e.length > 1)) return toString.call(A);
    if ('Object' == (t = e[1]))
      try {
  ...
  function FA(A, g, I) {
    ...
    for (var C = A.length, E = g(C), t = yA(), i = 0; i < C; i++) {
  ...
  var dA = null;
  function RA() {
    return (null !== dA && dA.buffer === sA.memory.buffer) || (dA = new Int32Array(sA.memory.buffer)), dA;
  }
  var pA = null;
  function JA(A, g) {
    return ((null !== pA && pA.buffer === sA.memory.buffer) || (pA = new Uint32Array(sA.memory.buffer)), pA).subarray(
      A / 4,
      A / 4 + g,
    );
  }
      ...
      C(
        ...
        [
          ...
          },
          {
            ...
            value: function (A) {
              try {
                var g = sA.__wbindgen_add_to_stack_pointer(-16),
                  I = FA(A, sA.__wbindgen_malloc, sA.__wbindgen_realloc),
                  B = kA;
                sA.vtwrapper_feed(g, this.ptr, I, B);
                var Q = RA()[g / 4 + 0],
                  C = RA()[g / 4 + 1],
                  E = JA(Q, C).slice();
                return sA.__wbindgen_free(Q, 4 * C), E;
              } finally {
                sA.__wbindgen_add_to_stack_pointer(16);
              }
            },
          },
          {
            ...
            value: function () {
              try {
                var A = sA.__wbindgen_add_to_stack_pointer(-16);
                sA.vtwrapper_inspect(A, this.ptr);
                var g = RA()[A / 4 + 0],
                  I = RA()[A / 4 + 1];
                return fA(g, I);
              } finally {
                sA.__wbindgen_add_to_stack_pointer(16), sA.__wbindgen_free(g, I);
              }
            },
          },
          {
            key: 'get_line',
            value: function (A) {
              return uA(sA.vtwrapper_get_line(this.ptr, A));
            },
          },
          {
            key: 'get_cursor',
            value: function () {
              return uA(sA.vtwrapper_get_cursor(this.ptr));
            },
          },
        ],
        [
          ...
          function (A) {
            for (;;)
              switch ((A.prev = A.next)) {
                ...
                case 8:
                  if (((A.prev = 8), (A.t0 = A.catch(2)), 'application/wasm' == g.headers.get('Content-Type'))) {
                    A.next = 14;
                    break;
                  }
                  console.warn(
        ...
        return t.wrap(function (A) {
          for (;;)
            switch ((A.prev = A.next)) {
              ...
              case 20:
                return (A.t1 = A.sent), (A.t2 = I), (A.next = 24), (0, A.t0)(A.t1, A.t2);
              case 24:
                return (
                  (B = A.sent),
                  (Q = B.instance),
  ...
  function xA(A, g) {
    ...
    if (!I) {
      if (
        ...
        (I = (function (A, g) {
          if (!A) return;
          if ('string' == typeof A) return jA(A, g);
          var I = Object.prototype.toString.call(A).slice(8, -1);
          'Object' === I && A.constructor && (I = A.constructor.name);
          if ('Map' === I || 'Set' === I) return Array.from(A);
          if ('Arguments' === I || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(I)) return jA(A, g);
        })(A)) ||
      ...
      return (
        C(A, [
                    ...
                    function (A) {
                      for (;;)
                        switch ((A.prev = A.next)) {
                              ...
                              (n = function () {
                                B++,
                                  !0 === s.loop || ('number' == typeof s.loop && B < s.loop)
                                    ? s.restart()
                                    : ((s.state = 'finished'), s.dispatchEvent('finish'));
                              }),
                              (o = !1),
                              (r = function (A) {
                                A && !o
                          ...
                          case 11:
                            return (
                              ...
                              (this.driver = this.driverFn(
                                {feed: Q, now: C, setTimeout: E, setInterval: i, onFinish: n, reset: e, setWaiting: r},
                                {
                                  cols: this.cols,
                                  rows: this.rows,
                              ...
                              'function' == typeof this.driver && (this.driver = {start: this.driver}),
                              (this.duration = this.driver.duration),
                              (this.cols = null !== (g = this.cols) && void 0 !== g ? g : this.driver.cols),
                              (this.rows = null !== (I = this.rows) && void 0 !== I ? I : this.driver.rows),
                          ...
                          case 22:
                            return (
                              (A.t2 = A.sent), A.abrupt('return', {isPausable: A.t0, isSeekable: A.t1, poster: A.t2})
                            );
                          case 24:
                          case 'end':
                            return A.stop();
                      ...
                      for (;;)
                        switch ((A.prev = A.next)) {
                          ...
                          case 3:
                            ...
                            break;
                          case 5:
                            'paused' == this.state ? this.resume() : 'finished' == this.state && this.restart();
                          case 6:
                          case 'end':
                            return A.stop();
                        }
                    ...
                    function (A) {
                      for (;;)
                        switch ((A.prev = A.next)) {
                          ...
                          case 4:
                            return this.dispatchEvent('terminalUpdate'), (A.next = 7), this.driver.start();
                          case 7:
                            (I = A.sent),
                              clearTimeout(g),
          ...
          },
          {
            ...
            value: function () {
              return (
                void 0 === this.initializeDriverPromise && (this.initializeDriverPromise = this.doInitializeDriver()),
                    ...
                    function (A) {
                      for (;;)
                        switch ((A.prev = A.next)) {
                          ...
                          case 3:
                            (Q = A.sent),
                              (this.duration = null !== (g = this.duration) && void 0 !== g ? g : Q.duration),
          ...
          },
          {
            ...
            value: function () {
              ...
              (void 0 !== this.vt && this.vt.cols === I && this.vt.rows === B) || this.initializeVt(I, B);
            },
          },
          {
            key: 'resetVt',
          ...
          },
          {
            key: 'initializeVt',
            value: function (A, g) {
              (this.vt = this.wasm.create(A, g)), (this.vt.cols = A), (this.vt.rows = g), this.changedLines.clear();
                    ...
                    function (A) {
                      for (;;)
                        switch ((A.prev = A.next)) {
                          ...
                          case 2:
                            if ((this.ensureVt(), (g = []), 'data:text/plain,' != this.poster.substring(0, 16))) {
                              A.next = 8;
                              break;
                            }
                            ...
                            break;
                          case 8:
                            if ('npt:' != this.poster.substring(0, 4) || 'function' != typeof this.driver.getPoster) {
                              A.next = 12;
                              break;
                            }
                          ...
                          case 12:
                            for (
                              ...
                              B.push({id: Q, segments: this.vt.get_line(Q)}), this.changedLines.add(Q);
                            return this.vt.feed('c'), (this.cursor = void 0), A.abrupt('return', {cursor: I, lines: B});
                          case 19:
                          case 'end':
                            return A.stop();
                        }
  ...
  const TA = Symbol('store-raw'),
    XA = Symbol('store-node'),
    OA = Symbol('store-name');
  function zA(A, g) {
    let I = A[o];
    if (!I) {
      Object.defineProperty(A, o, {value: (I = new Proxy(A, Ag))});
  ...
  function VA(A, g = new Set()) {
    let I, B, Q, C;
    if ((I = null != A && A[TA])) return I;
    if (!PA(A) || g.has(A)) return A;
    if (Array.isArray(A)) {
      ...
      for (let t = 0, i = I.length; t < i; t++)
        (C = I[t]), E[C].get || ((Q = A[C]), (B = VA(Q, g)) !== Q && (A[C] = B));
    }
    return A;
  }
  function _A(A) {
  ...
  const Ag = {
    get(A, g, I) {
      ...
      const Q = PA(B);
      if (J() && ('function' != typeof B || A.hasOwnProperty(g))) {
        let I, C;
        Q && (I = _A(B)) && ((C = I._ || (I._ = $A())), C()), (I = _A(A)), (C = I[g] || (I[g] = $A())), C();
      }
      return Q ? zA(B) : B;
    },
    set: () => !0,
    ...
    getOwnPropertyDescriptor: function (A, g) {
      ...
      return I && !I.get && I.configurable && g !== o && g !== XA && g !== OA
  ...
  function gg(A, g, I) {
    ...
    let t,
      i = _A(A);
    (t = i[g]) && t.$(), B && A.length !== Q && (t = i.length) && t.$(), E && (t = i._) && t.$();
  }
  function Ig(A, g, I = []) {
    let B,
      Q = A;
    if (g.length > 1) {
      ...
      const C = typeof B,
        E = Array.isArray(A);
      if (Array.isArray(B)) {
        for (let Q = 0; Q < B.length; Q++) Ig(A, [B[Q]].concat(g), I);
        return;
      }
      if (E && 'function' === C) {
        for (let Q = 0; Q < A.length; Q++) B(A[Q], Q) && Ig(A, [Q].concat(g), I);
        return;
      }
      if (E && 'object' === C) {
        const {from: Q = 0, to: C = A.length - 1, by: E = 1} = B;
        for (let B = Q; B <= C; B += E) Ig(A, [B].concat(g), I);
        return;
      }
      if (g.length > 1) return void Ig(A[B], g, [B].concat(I));
      (Q = A[B]), (I = [B].concat(I));
    }
    let C = g[0];
    ('function' == typeof C && ((C = C(Q, I)), C === Q)) ||
      (void 0 === B && null == C) ||
      ((C = VA(C)),
      void 0 === B || (PA(Q) && PA(C) && !Array.isArray(C))
        ? (function (A, g) {
  ...
  function Qg(A, g, I, B, Q) {
    const C = g[I];
    if (A === C) return;
    if (!PA(A) || !PA(C) || (Q && A[Q] !== C[Q])) return void (A !== C && gg(g, I, A));
    if (Array.isArray(A)) {
      if (A.length && C.length && (!B || (Q && null != A[0][Q]))) {
        let g, I, E, t, i, e, n, o;
        for (E = 0, t = Math.min(C.length, A.length); E < t && (C[E] === A[E] || (Q && C[E][Q] === A[E][Q])); E++)
          Qg(A[E], C, E, B, Q);
        ...
        for (
          ...
          r[i] = C[t];
        if (E > i || E > t) {
          for (I = E; I <= i; I++) gg(C, I, A[I]);
          for (; I < A.length; I++) gg(C, I, r[I]), Qg(A[I], C, I, B, Q);
          return void (C.length > A.length && gg(C, 'length', A.length));
        }
        for (n = new Array(i + 1), I = i; I >= E; I--)
          (e = A[I]), (o = Q ? e[Q] : e), (g = s.get(o)), (n[I] = void 0 === g ? -1 : g), s.set(o, I);
        for (g = E; g <= t; g++)
          (e = C[g]),
            (o = Q ? e[Q] : e),
            (I = s.get(o)),
            void 0 !== I && -1 !== I && ((r[I] = C[g]), (I = n[I]), s.set(o, I));
        for (I = E; I < A.length; I++) I in r ? (gg(C, I, r[I]), Qg(A[I], C, I, B, Q)) : gg(C, I, A[I]);
      } else for (let g = 0, I = A.length; g < I; g++) Qg(A[g], C, g, B, Q);
      return void (C.length > A.length && gg(C, 'length', A.length));
    }
    const E = Object.keys(A);
    for (let g = 0, I = E.length; g < I; g++) Qg(A[E[g]], C, E[g], B, Q);
    const t = Object.keys(C);
    for (let g = 0, I = t.length; g < I; g++) void 0 === A[t[g]] && gg(C, t[g], void 0);
  }
  function Cg(A, g = {}) {
    const {merge: I, key: B = 'id'} = g,
      Q = VA(A);
    return (A) => (PA(A) && PA(Q) ? (Qg(Q, {state: A}, 'state', I, B), A) : Q);
  }
    ...
    return (
      ...
      k(
        function (I) {
          var B,
            Q = (function (A, g) {
              var I = A.get('inverse') ? (A.has('bg') ? A.get('bg') : 'bg') : A.get('fg'),
            ...
            E = (function (A) {
              var g = A.get('inverse') ? A.get('bg') : A.get('fg'),
                ...
                B = {};
              return 'string' == typeof g && (B.color = g), 'string' == typeof I && (B['background-color'] = I), B;
            })(A.attrs);
          return (
            ...
            (I._v$2 = (function (A, g, I = {}) {
              ...
              for (C = 0, E = Q.length; C < E; C++) {
                const B = Q[C];
                B && 'undefined' !== B && !g[B] && (tA(A, B, !1), delete I[B]);
              }
              for (C = 0, E = B.length; C < E; C++) {
                const Q = B[C],
                  E = !!g[Q];
                Q && 'undefined' !== Q && I[Q] !== E && E && (tA(A, Q, !0), (I[Q] = E));
              }
              return I;
            })(g, C, I._v$2)),
  ...
  const eg = IA('<span class="line"></span>');
  var ng = function (A) {
    var g;
    return (
      EA(
          ...
          get each() {
            return (function () {
              if ('number' == typeof A.cursor) {
                for (var g = [], I = 0, B = 0; B < A.segments.length && I + A.segments[B][0].length - 1 < A.cursor; ) {
                  var Q = A.segments[B];
                ...
                if (B < A.segments.length) {
                  ...
                  for (
                    i > 0 && g.push([C[0].substring(0, i), C[1]]),
                      ...
                      i < C[0].length - 1 && g.push([C[0].substring(i + 1), C[1]]),
                      B++;
                    B < A.segments.length;
  ...
  const og = IA('<pre class="asciinema-terminal"></pre>');
  var rg = function (A) {
    var g,
      I,
      B = function () {
        ...
        O(z, {
          ...
          children: function (g, I) {
            return (
              (C = M(
                function () {
                  return I() === (null === (g = A.cursor) || void 0 === g ? void 0 : g[1]);
                  var g;
                },
                void 0,
                (Q = !0) ? void 0 : {equals: Q},
  ...
  const sg = IA(
    ...
    ag = IA('<svg version="1.1" viewBox="0 0 12 12" class="icon"><path d="M1,0 L11,6 L1,12 Z"></path></svg>'),
    cg = IA('<span class="playback-button"></span>'),
    wg = IA('<span class="progressbar"><span class="bar"><span class="gutter"><span></span></span></span></span>'),
    ug = IA(
  ...
  function Dg(A) {
    ...
    var g = Math.floor(A / 60),
      I = A % 60,
      B = '';
    return g < 10 && (B += '0'), (B += ''.concat(g, ':')), I < 10 && (B += '0'), (B += ''.concat(I));
  }
  var hg = function (A) {
    var g,
      I,
      ...
      i = function () {
        return 'number' == typeof A.remainingTime ? '-' + Dg(A.remainingTime) : t();
      },
      e = function (g) {
          ...
          get children() {
            ...
            return (
              ...
              k(function (g) {
                return CA(
                  B,
                  {width: '100%', transform: 'scaleX('.concat(A.progress || 0), 'transform-origin': 'left center'},
                  g,
                );
              }),
              g
  ...
  BA(['click', 'mousedown']);
  const lg = IA('<div class="loading"></div>');
  var yg = function (A) {
    for (var g, I = ['▓', '▒', '░', '▒'], B = 1, Q = '', C = 0; C < A.cols - 1; C++) Q = Q.concat(' ');
    var E,
      t = [Q, new Map()],
      i = new Map([['inverse', !0]]),
      e = n(Bg({lines: [{segments: [t, [I[0], i]]}]}), 2),
      o = e[0],
      r = e[1];
    return (
      R(function () {
        g = setInterval(function () {
          r('lines', 0, {segments: [t, [I[B % I.length], i]]}), B++;
        }, 250);
      }),
      p(function () {
        clearInterval(g);
  ...
  BA(['click']);
  const kg = IA('<div class="asciinema-player-wrapper" tabindex="-1"><div></div></div>');
  var Ng = function (A) {
    var g,
      B,
      Q,
    ...
    r.addEventListener('starting', function () {
      ...
      r.addEventListener('reset', function (A) {
        var g = A.cols,
          I = A.rows;
        I < c.rows && w('lines', c.lines.slice(0, I)), w({cols: g, rows: I});
      }),
    ...
    R(
              ...
              switch ((A.prev = A.next)) {
                case 0:
                  return (
                    ...
                    w({
                      charW: e.clientWidth / u(),
                      charH: e.clientHeight / D(),
                      bordersW: e.offsetWidth - e.clientWidth,
                      bordersH: e.offsetHeight - e.clientHeight,
                      containerW: E.offsetWidth,
                      containerH: E.offsetHeight,
                    }),
                    (o = new ResizeObserver(function (A) {
                      w({containerW: E.offsetWidth, containerH: E.offsetHeight}),
                        E.dispatchEvent(new CustomEvent('resize', {detail: {el: i}}));
                    })).observe(E),
                    (A.next = 5),
                    r.init()
                  );
                case 5:
                  (g = A.sent),
                    ...
                    void 0 === Q || s || w({lines: Q.lines, cursor: Q.cursor}),
                    s && r.play();
                case 12:
                case 'end':
                  return A.stop();
      ...
      p(function () {
        r.stop(), v(), L(), o.disconnect();
      }),
      N(function () {
        var A = c.coreState;
        'playing' === A ? (S(), J()) : 'initial' !== A && (v(), L(), Y());
      });
    var h = function () {
      ...
      l = M(function () {
        ...
        if (c.charW) {
          ...
          var I = c.charW * u() + c.bordersW,
            B = c.charH * D() + c.bordersH,
            Q = null !== (g = A.fit) && void 0 !== g ? g : 'width';
          if ('both' === Q || c.isFullscreen) Q = c.containerW / c.containerH > I / B ? 'height' : 'width';
      ...
      y = function () {
        ...
        w(
          'isFullscreen',
          null !== (A = document.fullscreenElement) && void 0 !== A ? A : document.webkitFullscreenElement,
        );
      },
      f = function () {
        var A, g, I, B;
        c.isFullscreen
          ? (null !==
              (A = null !== (g = document.exitFullscreen) && void 0 !== g ? g : document.webkitExitFullscreen) &&
            void 0 !== A
              ? A
              : function () {}
            ).apply(document)
          : (null !== (I = null !== (B = E.requestFullscreen) && void 0 !== B ? B : E.webkitRequestFullscreen) &&
            void 0 !== I
              ? I
              : function () {}
            ).apply(E);
      ...
      return (
        ...
        k(
          function (B) {
            var Q,
              C = c.showControls,
              E = 'asciinema-player asciinema-theme-'.concat(null !== (Q = A.theme) && void 0 !== Q ? Q : 'asciinema'),
              t = (function () {
                var g = {};
                (!1 !== A.fit && 'none' !== A.fit) ||
                ...
                return void 0 === I
                  ? ((g.height = 0), g)
                  : (void 0 !== I.width &&
                      ((g.width = ''.concat(I.width, 'px')), (g.height = ''.concat(I.height, 'px'))),
                    g);
              })();
            return (
      ...
      C(g, [
        ...
        },
        {
          ...
          value: function () {
            ...
            return {
              next: function () {
                for (Q === C.length && ((C = []), (Q = 0)); 0 === C.length && B < I.input.length; )
                  t.step(I.input[B++]);
                return (
                  0 !== C.length || E || (t.flush(), (E = !0)), C.length > 0 ? {done: !1, value: C[Q++]} : {done: !0}
                );
              },
            };
          },
  ...
  function dg(A, g, B) {
            ...
            for (;;)
              switch ((A.prev = A.next)) {
                case 0:
                  ...
                  return (A.next = 3), fetch(a, w);
                case 3:
                  if ((I = A.sent).ok) {
                    A.next = 6;
                    break;
                  }
                  throw 'failed fetching asciicast file: '.concat(I.statusText, ' (').concat(I.status, ')');
                case 6:
                  return (A.t0 = Rg), (A.next = 9), I.text();
                case 9:
                  (A.t1 = A.sent),
                    (B = (0, A.t0)(A.t1)),
                    (Q = B.cols),
                    (C = B.rows),
                    (y = null !== (g = y) && void 0 !== g ? g : B.idleTimeLimit),
                    (n = Jg(B.frames, y, f)),
                    (E = n.frames),
                    (e = n.effectiveStartAt),
                    (i = E[E.length - 1][0]);
                case 18:
                case 'end':
                  return A.stop();
    ...
    function F() {
      ...
      if (A) {
        var g = 1e3 * A[0] - (D() - o);
        g < 0 && (g = 0), (n = h(d, g));
      } else (n = null), (r = 1e3 * i), l();
    }
    function d() {
      var A,
        g = E[G];
      do {
        u(g[1]), (k = 1e3 * g[0]), (g = E[++G]), (A = D() - o);
      } while (g && A > 1e3 * g[0]);
      F();
    }
    function R() {
      clearTimeout(n), (n = null), (r = D() - o);
    }
    function p() {
      (o = D() - r), (r = null), F();
    }
    function J(A) {
      ...
      if ((g && R(), 'string' == typeof A)) {
        ...
        '<<' === A
          ...
          : '>>>' === A
          ? (A = B + 0.1 * i)
          : '%' === A[A.length - 1] && (A = (parseFloat(A.substring(0, A.length - 1)) / 100) * i);
      }
      var Q = 1e3 * Math.min(Math.max(A, 0), i);
      Q < k && (u('c'), (G = 0), (k = 0));
      for (var C = E[G]; C && 1e3 * C[0] < Q; ) u(C[1]), (k = 1e3 * C[0]), (C = E[++G]);
      (r = Q), g && p();
    }
    return {
      init: (function () {
              ...
              for (;;)
                switch ((A.prev = A.next)) {
                  case 0:
                    return (A.next = 2), N();
                  case 2:
                    return A.abrupt('return', {cols: Q, rows: C, duration: i});
                  case 3:
                  case 'end':
                    return A.stop();
                }
      ...
      getPoster: function (A) {
        return (function (A) {
          for (var g = 1e3 * A, I = [], B = 0, Q = E[0]; Q && 1e3 * Q[0] < g; ) I.push(Q[1]), (Q = E[++B]);
          return I;
        })(A);
      },
      getCurrentTime: function () {
        return n ? (D() - o) / 1e3 : (null !== (A = r) && void 0 !== A ? A : 0) / 1e3;
        var A;
      },
    };
  }
  function Rg(A) {
    try {
      return (function (A) {
        ...
        return {cols: I.width, rows: I.height, idleTimeLimit: I.idle_time_limit, frames: B};
      })(A);
    } catch (g) {
      return (function (A) {
        var g = JSON.parse(A),
  ...
  function pg(A) {
    ...
    return A.transform(function (A) {
      ...
      return {
        step: function (Q) {
          I++, void 0 !== g ? (Q[0] - g[0] < 0.016666666666666666 ? (g[1] += Q[1]) : (A(g), (g = Q), B++)) : (g = Q);
        },
        flush: function () {
          void 0 !== g && (A(g), B++), console.debug('batched '.concat(I, ' frames to ').concat(B, ' frames'));
        },
      };
    });
  }
          ...
          start: function () {
            setTimeout(function () {
              ...
              (Q = setInterval(function () {
                ...
                C('\r');
                for (var B = 0; B < o; B++) C(' ');
                C('[32m'), g < 10 && C('0'), C(''.concat(g)), C('[39;5m:[25;35m'), I < 10 && C('0'), C(''.concat(I));
              }, 1e3));
          },
          stop: function () {
            clearInterval(Q);
    ...
    return (
      C(A, [
        ...
        },
        {
          ...
          value: function () {
            var A = this.first;
            if (void 0 !== A) return (this.first = A.next), void 0 === this.first && (this.last = void 0), A.item;
            var g = this;
                      ...
                      for (;;)
                        switch ((I.prev = I.next)) {
                          case 0:
                            C = g.pop();
                          case 1:
                            if ('object' === i(C) && 'function' == typeof C.then) {
                              I.next = 9;
                              break;
                            }
                            if (!B) {
            ...
            t.mark(function I(Q) {
              ...
              return t.wrap(function (I) {
                for (;;)
                  switch ((I.prev = I.next)) {
                    case 0:
                      if (((C = vg() - B), !((E = 1e3 * (Q[0] + g)) > C))) {
                        I.next = 5;
                        break;
                      }
                      return (I.next = 5), Ug(E - C);
                    case 5:
                      A(Q[2]);
                    case 6:
                    case 'end':
  ...
  function Kg(A, g) {
    ...
    function a() {
      ((I = new WebSocket(Q)).binaryType = 'arraybuffer'),
        (I.onopen = function () {
          console.debug('websocket: opened'), e(!1), s(), (o = 250);
        }),
        (I.onmessage = function (A) {
          ...
          } else B.pushText(n.decode(A.data));
        }),
        (I.onclose = function (A) {
          r || A.wasClean
            ? console.debug('websocket: closed')
            : (console.debug('websocket: unclean close, reconnecting in '.concat(o, '...')),
              e(!0),
              setTimeout(a, o),
              (o = Math.min(2 * o, 5e3)));
        });
    ...
    return {
      ...
      stop: function () {
        (r = !0), void 0 !== B && B.stop(), void 0 !== I && I.close();
      },
    };
  }
  function bg(A, g) {
      ...
      var I,
        ...
        i = {
          ...
          addEventListener: function (A, g) {
            return C.addEventListener(A, g.bind(i));
          },
        };
      return i;
    }),
