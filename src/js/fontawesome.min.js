      ...
      s
        ...
        : ((g = (p = t).children),
          ...
          at((p = p.transform)) &&
            ...
            (y = 0.5),
            (h.style = tt(
              k(k({}, t), {}, {'transform-origin': ''.concat(v + p.x / 16, 'em ').concat(y + p.y / 16, 'em')}),
            ))),
      ...
      icon: Array.isArray(t)
        ? {
            ...
            children: [
              {
                tag: 'path',
                attributes: {class: ''.concat(X.familyPrefix, '-').concat(W.SECONDARY), fill: 'currentColor', d: t[0]},
              },
              {
                tag: 'path',
                attributes: {class: ''.concat(X.familyPrefix, '-').concat(W.PRIMARY), fill: 'currentColor', d: t[1]},
              },
            ],
          }
  ...
  function Qt(i, r) {
    ...
    return (
      ...
      new Promise(function (t, a) {
        ...
        if (
          ('fa' === o && ((n = jt(i) || {}), (i = n.iconName || i), (r = n.prefix || r)), i && r && Gt[r] && Gt[r][i])
        )
          return t(Kt(Gt[r][i]));
        (e = i),
          (n = r),
  ...
  function va(t) {
    ...
    return (
      ...
      (i.iconName && i.prefix) ||
        (i.prefix &&
          0 < n.length &&
          (i.iconName = ((e = i.prefix), (n = t.innerText), (xt[e] || {})[n] || zt(i.prefix, bt(t.innerText))))),
      i
    );
  }
  function pa(t, a) {
            ...
            return Xt({type: 'layer'}, function () {
              ...
              return (
                ...
                [
                  {
                    tag: 'span',
                    attributes: {class: [''.concat(X.familyPrefix, '-layers')].concat(l(n)).join(' ')},
                    children: a,
                  },
                ]
              );
      ...
      provides: function (t) {
        t.generateLayersText = function (t, a) {
          ...
          return (
            ...
            Promise.resolve([
              t,
              Vt({content: t.innerHTML, width: o, height: s, transform: i, title: n, extra: r, watchable: !0}),
            ])
          );
        };
      },
          ...
          !u || c || (f && f.getAttribute(C) === n && f.getAttribute(P) === i)
            ...
            : (b.setAttribute(p, i),
              ...
              Qt(u, n)
                .then(function (t) {
                  var a = qt(
                      k(k({}, r), {}, {icons: {main: t, mask: Mt()}, prefix: n, iconName: i, extra: o, watchable: !0}),
                    ),
