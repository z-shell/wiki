    ...
    function R() {
      ...
      if (!i) {
        if (
          ...
          return (
            ((e = makeError('timeout', 'Load timeout for modules: ' + o, null, o)).contextName = l.contextName), O(e)
          );
        u &&
          each(a, function (e) {
            !(function n(o, a, s) {
                ...
                if (((this.defining = !0), this.depCount < 1 && !this.defined)) {
                  if (isFunction(o)) {
                    ...
                    if (
                      (this.map.isDefine &&
                        void 0 === n &&
                        ((e = this.module) ? (n = e.exports) : this.usingExports && (n = this.exports)),
                      t)
                    )
                      return (
          ...
          ((f[this.map.id] = this).enabled = !0),
            ...
            each(
              ...
              bind(this, function (e, t) {
                ...
                if ('string' == typeof e) {
                  if (
                    ((e = S(e, this.map.isDefine ? this.map : this.map.parentMap, !1, !this.skipMap)),
                    (this.depMaps[t] = e),
                    (n = getOwn(c, e.id)))
                  )
