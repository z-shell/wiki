...
keywords:
  - annex,
  - bin-gem-node
github: z-shell/z-a-bin-gem-node
---
...
```zsh title="print $PATH" showLineNumbers
...
```zsh title="which myfzf" showLineNumbers
myfzf () {
  local bindir="/home/sall/.zi/plugins/junegunn---fzf"
...
```zsh title="which asciidoctor" showLineNumbers
asciidoctor () {
...
```zsh title="which remark" showLineNumbers
remark () {
...
```zsh title="which youtube-dl" showLineNumbers
youtube-dl () {
...
```zsh title="which myfunc" showLineNumbers
myfunc () {
...
```zsh title="myfun" showLineNumbers
...
```zsh title="which myscript" showLineNumbers
myscript () {
  local bindir="/home/sall/.zi/plugins/z-shell---0"
  local -xU PATH="$bindir":"$PATH"
  () {
...
- <Link className="github-link" href="https://github.com/z-shell/z-a-bin-gem-node">
