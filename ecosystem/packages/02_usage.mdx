...
### Apache Portable Runtime (APR) library {/* #apache-portable-runtime-apr-library */}
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        <Emoji symbol="✅" label="check-mark-button" /> (default)
      </td>
      <td>
        <Emoji symbol="❌" label="cross-mark" />
      </td>
      <td>
...
### `asciidoctor` Markdown processor {/* #asciidoctor-markdown-processor */}
...
### `dircolors-material` color scheme {/* #dircolors-material-color-scheme */}
...
### `doctoc` Markdown processor {/* #doctoc-markdown-processor */}
...
### `fzy` command-line fuzzy finder {/* #fzy-command-line-fuzzy-finder */}
...
### `LS_COLORS` color scheme {/* #ls_colors-color-scheme */}
...
### `remark` Markdown processor {/* #remark-markdown-processor */}
...
### Zsh mirror of zsh-users {/* #zsh-mirror-of-zsh-users */}
...
### Statically-linked, hermetic, relocatable Zsh {/* #statically-linked-hermetic-relocatable-zsh */}
