...
<CommandBlock>zpmod source-study [options]</CommandBlock>
...
<CommandBlock>zpmod report-append [options]</CommandBlock>
...
<CommandBlock>zi light z-shell/zgdbm</CommandBlock>
