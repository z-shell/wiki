...
## <i class="fa-brands fa-github"></i> [z-shell/zi-console][z-shell-zi-console] {/* #i-classfa-brands-fa-githubi-z-shellzi-consolez-shell-zi-console */}
...
## Zi Console keybindings {/* #zi-console-keybindings */}
...
## Zi Console preview {/* #zi-console-preview */}

<Player src="https://asciinema.org/a/512999.cast" rows={21} cols={125} preload />

## Install Zi Console {/* #install-zi-console */}
...
### Build the `zsh/curses` module {/* #build-the-zshcurses-module */}
