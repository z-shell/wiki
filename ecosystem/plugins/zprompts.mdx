...
## <i class="fa-brands fa-github"></i> [z-shell/zprompts][] {/* #i-classfa-brands-fa-githubi-z-shellzprompts */}
...
<ImgShow width={1391} height={664} img="/img/cast/gif/zsh/zprompts.gif" alt="Zprompts Preview" />

<ImgShow width={1391} height={504} img="/img/cast/gif/zsh/zprompts_theming.gif" alt="Zprompts Theming Preview" />

## Install Zprompts {/* #install-zprompts */}
