...
## <i class="fa-brands fa-github"></i> [z-shell/zconvey][] {/* #i-classfa-brands-fa-githubi-z-shellzconvey */}
...
<ImgShow width={1679} height={888} img="/img/cast/gif/zsh/zconvey.gif" alt="ZConvey Preview" />
...
## Install zconvey {/* #install-zconvey */}
