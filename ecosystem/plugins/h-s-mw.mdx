...
## <i class="fa-brands fa-github"></i> [z-shell/h-s-mw](https://github.com/z-shell/h-s-mw) {/* #i-classfa-brands-fa-githubi-z-shellh-s-mw */}
...
<video autoPlay loop muted playsInline style={{width: "100%", borderRadius: "var(--ifm-global-radius)"}}>
  <source src="/img/cast/webm/hsmw/hsmw-1.webm" type="video/webm" />
  <img src="/img/cast/gif/hsmw/hsmw-1.gif" alt="History search for multiple words" />
</video>

## Install H-S-MW {/* #install-h-s-mw */}
...
### Context viewing {/* #context-viewing */}
...
<video autoPlay loop muted playsInline style={{width: "100%", borderRadius: "var(--ifm-global-radius)"}}>
  <source src="/img/cast/webm/hsmw/hsmw-2.webm" type="video/webm" />
  <img src="/img/cast/gif/hsmw/hsmw-2.gif" alt="History search for multiple words 2" />
</video>
...
#### Examples of customizing syntax highlighting {/* #examples-of-customizing-syntax-highlighting */}
