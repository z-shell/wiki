...
## <i class="fa-brands fa-github"></i> [z-shell/zsh-editing-workbench][zsh-editing-workbench] {/* #i-classfa-brands-fa-githubi-z-shellzsh-editing-workbenchzsh-editing-workbench */}
...
## Install Zsh Editing Workbench {/* #install-zsh-editing-workbench */}
...
[^2]:
    A **word style** defines a way Zsh recognizes segments (words) of text in commands that want to use the style information. The style can be configured in **zew.conf** to be one of:
