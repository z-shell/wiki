...
## <i class="fa-brands fa-github"></i> [z-shell/zsh-unique-id][zsh-unique-id] {/* #i-classfa-brands-fa-githubi-z-shellzsh-unique-idzsh-unique-id */}
...
## Install Zsh Unique ID {/* #install-zsh-unique-id */}
