...
## <i class="fa-brands fa-github"></i> [z-shell/zbrowse][] {/* #i-classfa-brands-fa-githubi-z-shellzbrowse */}
...
<ImgShow width={1535} height={792} img="/img/cast/gif/zsh/zbrowse.gif" alt="ZBrowse Preview" />

## Install Zbrowse {/* #install-zbrowse */}
