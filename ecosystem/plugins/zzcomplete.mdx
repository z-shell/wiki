...
## <i class="fa-brands fa-github"></i> [z-shell/zzcomplete][] {/* #i-classfa-brands-fa-githubi-z-shellzzcomplete */}
...
## ZZComplete preview {/* #zzcomplete-preview */}

<Player src="/cdn/cast/293365.cast" rows={21} cols={104} speed={1} idleTimeLimit={1} preload />

## Install ZZComplete {/* #install-zzcomplete */}
