...
<ImgShow img="/img/plugins/fsh/cmdsubst.png" alt="Syntax highlighting command substitution" />

In the above screen-shot the interior of `$( ... )` uses different colors than the rest of the code. Example for `eval`:

<ImgShow img="/img/plugins/fsh/eval_cmp.png" alt="Syntax highlighting eval" />
...
<ImgShow img="/img/plugins/fsh/parameter.png" alt="Syntax highlighting parameter" />

<ImgShow img="/img/plugins/fsh/in_string.png" alt="Syntax highlighting in string" />

### Brackets {/* #brackets */}

<ImgShow img="/img/plugins/fsh/brackets.gif" alt="Syntax highlighting brackets" />

### Conditions {/* #conditions */}

Comparing to the project `zsh-users/zsh-syntax-highlighting` (the upper line):

<ImgShow img="/img/plugins/fsh/cplx_cond.png" alt="Syntax highlighting conditions" />

### Strings {/* #strings */}

Exact highlighting that recognizes quoting.

<ImgShow img="/img/plugins/fsh/ideal-string.png" alt="Syntax highlighting strings" />

#### here-strings {/* #here-strings */}

<ImgShow img="/img/plugins/fsh/herestring.png" alt="Syntax highlighting here-strings" />

### `exec` descriptor-variables {/* #exec-descriptor-variables */}

Comparing to the project `zsh-users/zsh-syntax-highlighting` (the upper line):

<ImgShow img="/img/plugins/fsh/execfd_cmp.png" alt="Syntax highlighting exec" />

### The for-loops and alternate syntax (brace `{`/`}` blocks) {/* #the-for-loops-and-alternate-syntax-brace--blocks */}

<ImgShow img="/img/plugins/fsh/for-loop-cmp.png" alt="Syntax highlighting loops" />

### Function definitions {/* #function-definitions */}

Comparing to the project `zsh-users/zsh-syntax-highlighting` (the upper 2 lines):

<ImgShow img="/img/plugins/fsh/function.png" alt="Syntax highlighting function" />
...
<ImgShow img="/img/plugins/fsh/math.gif" alt="Syntax highlighting math" />

### Zcalc highlighting {/* #zcalc-highlighting */}

<ImgShow img="/img/plugins/fsh/zcalc.png" alt="Syntax highlighting zcalc" />
