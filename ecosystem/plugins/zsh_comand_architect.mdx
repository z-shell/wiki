...
## <i class="fa-brands fa-github"></i> [z-shell/zsh-cmd-architect][zsh-cmd-architect] {/* #i-classfa-brands-fa-githubi-z-shellzsh-cmd-architectzsh-cmd-architect */}
...
## Install Zsh Command Architect {/* #install-zsh-command-architect */}
