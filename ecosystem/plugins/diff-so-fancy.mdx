...
## <i class="fa-brands fa-github"></i> [z-shell/zsh-diff-so-fancy][zsh-diff-so-fancy] {/* #i-classfa-brands-fa-githubi-z-shellzsh-diff-so-fancyzsh-diff-so-fancy */}
...
<video autoPlay loop muted playsInline style={{width: "100%", borderRadius: "var(--ifm-global-radius)"}}>
  <source src="/img/cast/webm/dsf/zsh-diff-so-fancy.webm" type="video/webm" />
  <img src="/img/cast/gif/dsf/zsh-diff-so-fancy.gif" alt="Zsh Diff So Fancy" />
</video>
...
#### changeHunkIndicators {/* #changehunkindicators */}
...
#### stripLeadingSymbols {/* #stripleadingsymbols */}
...
#### useUnicodeRuler {/* #useunicoderuler */}
