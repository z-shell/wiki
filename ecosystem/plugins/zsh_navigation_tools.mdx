...
## <i class="fa-brands fa-github"></i> [z-shell/zsh-navigation-tools][] {/* #i-classfa-brands-fa-githubi-z-shellzsh-navigation-tools */}
...
## Install Zsh Navigation Tools {/* #install-zsh-navigation-tools */}
