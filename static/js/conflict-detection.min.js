        ...
        var e = Array.from(u.getElementsByTagName('link')).filter(function (e) {
          ...
          t = Array.from(u.getElementsByTagName('style')).filter(function (e) {
            return (
              !e.hasAttribute(x) &&
              (!f.FontAwesomeConfig ||
                !e.innerText.match(new RegExp('svg:not\\(:root\\)\\.'.concat(f.FontAwesomeConfig.replacementClass))))
            );
          });
        function n(e, t) {
              ...
              if (0 < (e = Object.keys(n.conflict).length)) {
                ...
                for (i in n.conflict) {
                  ...
                  c[i] = {
                    ...
                    'innerText excerpt':
                      a.innerText && '' !== a.innerText ? a.innerText.slice(0, 200) + '...' : '(empty)',
                  };
                }
                console.table(c);
              }
              ...
              if (0 < (e = Object.keys(r).length)) {
                ...
                for (u in r) {
                  ...
                  d[u] = {
                    ...
                    'innerText excerpt':
                      m.innerText && '' !== m.innerText ? m.innerText.slice(0, 200) + '...' : '(empty)',
                  };
                }
                console.table(d);
              }
