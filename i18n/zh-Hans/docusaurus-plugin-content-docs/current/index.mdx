...
## <i class="fa-beat fa-solid fa-heart"></i> Neat and flexible
...
## <i class="fa-solid fa-circle-info fa-beat-fade"></i> Familiarize and control
...
<Link href='https://github.com/orgs/z-shell'>
  ...
  <ImgShow
    ...
    width='100%'
    height='auto'
    img='https://raw.githubusercontent.com/z-shell/.github/main/metrics/plugin/stargazers/worldmap.svg'
  />
</Link>
