...
description: Use Zi's concise for syntax to load groups of plugins and snippets.
keywords:
  - for
  - syntax
  - how-to-use
...
## <i class="fa-solid fa-list"></i> Oh-My-Zsh, [turbo][6] Oh-My-Zsh and the The "For" syntax {/* #i-classfa-solid-fa-listi-oh-my-zsh-turbo6-oh-my-zsh-and-the-the-for-syntax */}

### <i class="fa-solid fa-forward-step"></i> Without [turbo mode][6] and The "For" {/* #i-classfa-solid-fa-forward-stepi-without-turbo-mode6-and-the-for */}
...
### <i class="fa-solid fa-forward-fast"></i> With [turbo mode][6] and The "For" {/* #i-classfa-solid-fa-forward-fasti-with-turbo-mode6-and-the-for */}
...
## <i class="fa-solid fa-book-bookmark"></i> Summary {/* #i-classfa-solid-fa-book-bookmarki-summary */}
