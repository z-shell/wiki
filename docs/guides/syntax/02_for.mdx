...
It allows providing common/default ice-modifiers for a **set of plugins** or to source **multiple files** with the ices: [src, pick, multisrc][src-pick-multisrc].
...
{/* Adding header with explicit ID */}

<h2 id='oh-my-zsh-turbo-and-for-syntax'>
  <Icon icon='fa-solid fa-list' /> Oh-My-Zsh, [turbo][6] Oh-My-Zsh and the The "For" syntax
</h2>

{/* Adding header with explicit ID */}

<h3 id='without-turbo-mode-and-for'>
  <Icon icon='fa-solid fa-forward-step' /> Without [turbo mode][6] and The "For"
</h3>
...
<h3 id='with-turbo-mode-and-for'>
  <Icon icon='fa-solid fa-forward-fast' /> With [turbo mode][6] and The "For"
</h3>
...
<h2 id='summary'>
  <Icon icon='fa-solid fa-book-bookmark' /> Summary
</h2>
