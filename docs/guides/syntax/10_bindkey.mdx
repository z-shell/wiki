...
description: Remap plugin key bindings with Zi's bindmap ice.
keywords:
  - syntax
  - bindkey
  - bindmap
...
## <i class="fa-solid fa-keyboard"></i> Bindkey {/* #i-classfa-solid-fa-keyboardi-bindkey */}

General Zsh key-binding guidance now lives in the Community [Key Bindings](/community/zsh-guide/key-bindings) guide.

## <i class="fa-solid fa-delete-left"></i> Delete key binding {/* #i-classfa-solid-fa-delete-lefti-delete-key-binding */}

See [Remove a key binding](/community/zsh-guide/key-bindings#remove-a-key-binding). The Community guide also explains why `bindkey -r`, not `bindkey -d`, removes an individual binding.
...
### <i class="fa-solid fa-circle-check"></i> Examples for `bindmap'…'` {/* #i-classfa-solid-fa-circle-checki-examples-for-bindmap */}
...
### <i class="fa-solid fa-circle-check"></i> Explanation {/* #i-classfa-solid-fa-circle-checki-explanation */}
...
### <i class="fa-solid fa-circle-check"></i> Using the <kbd>UPAR</kbd> shorthands {/* #i-classfa-solid-fa-circle-checki-using-the-kbduparkbd-shorthands */}
