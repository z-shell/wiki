...
### <Icon name="circle-check" /> Examples for `bindmap'…'`
...
### <Icon name="circle-check" /> Explanation
...
### <Icon name="circle-check" /> Using `bindmap'…'` in light mode {#trackbinds}
...
### <Icon name="circle-check" /> Using the <kbd>UPAR</kbd> shorthands
