---
id: standard
title: "\U0001F500 Standard Syntax"
...
## <Icon icon="fas fa-circle-info"></Icon> Introduction
...
## <Icon icon="fas fa-arrow-down-short-wide"></Icon> Order of execution {#order-of-execution}
...
### <Icon icon="fa-solid fa-list"></Icon> A few remarks {#a-few-remarks}
...
### <Icon icon="fa-solid fa-list"></Icon> Syntax alternatives {#syntax-alternatives}
...
### <Icon icon="fa-solid fa-circle-nodes"></Icon> Utilizing "make" {#utilizing-make}
...
### <Icon icon="fa-solid fa-arrows-to-dot"></Icon> Compiling programs {#compiling-programs}
...
### <Icon icon="fa-solid fa-palette"></Icon> LS_COLORS {#ls_colors}
...
### <Icon icon="fa-solid fa-folder-tree"></Icon> Direnv {#direnv}
...
#### <Icon icon="fa-solid fa-wand-magic-sparkles"></Icon> Glance at the 'for' syntax {#glance-at-the-for-syntax}
