---
id: standard
title: "🔀 Zi standard syntax"
sidebar_position: 1
toc_max_heading_level: 3
image: /img/png/theme/z/320x320.png
description: Use Zi's standard command and ice-modifier syntax.
keywords:
  - syntax
  - standard
  - how-to-use
...
## <i class="fas fa-circle-info"></i> Introduction {/* #i-classfas-fa-circle-infoi-introduction */}
...
```zi
zi snippet https://raw.githubusercontent.com/z-shell/src/main/public/zsh/snippets/welcome.zsh
```
...
```zi showLineNumbers
zi ice multisrc'{funct*,misc}.zsh' pick'/dev/null'
zi light some/plugin
```

```zi showLineNumbers
zi ice multisrc'misc.zsh functions.zsh' pick'/dev/null'
zi light some/plugin
```
...
zi ice multisrc"\$array" pick'/dev/null'
zi light some/plugin
```
...
```zi showLineNumbers
array=({functions,misc}.zsh)
zi ice multisrc'); local i; for i in $array; do reply+=( ${i/.zsh/.sh} ); done; ((1)' pick'/dev/null'
zi light some/plugin
```
...
```zsh title="zi report test" showLineNumbers
...
```zsh title="zi unload test" showLineNumbers
...
```zsh title="zi report romkatv/powerlevel10k" showLineNumbers
