...
## <Icon icon="fa-solid fa-list" /> Ice effects
...
## <Icon icon="fa-solid fa-list" /> Cloning options
...
## <Icon icon="fa-solid fa-list" /> Selection of files (source '…')
...
## <Icon icon="fa-solid fa-list" /> Conditional loading
...
## <Icon icon="fa-solid fa-list" /> Plugin output
...
## <Icon icon="fa-solid fa-list" /> Completions {#completions}
...
## <Icon icon="fa-solid fa-list" /> Command execution after cloning, updating or loading
...
## <Icon icon="fa-solid fa-list" /> Sticky-Emulation Of other shells
...
[^6]: Example: `zi ice if'[[ -n "$commands[otool]" ]]'` or `zi ice if'[[ $OSTYPE = darwin* ]]'`.
...
[zi-syntax]: /docs/category/️-syntax
