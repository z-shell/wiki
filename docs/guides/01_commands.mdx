...
## Commands available using <kbd>^TAB</kbd> <Link to="/docs/getting_started/installation#enable-zi-completions">completion</Link> {/* #commands-available-using-kbdtabkbd-link-todocsgetting_startedinstallationenable-zi-completionscompletionlink */}
