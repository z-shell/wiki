...
## <i class="fa-solid fa-spinner fa-spin-pulse"></i> Fast and feature-rich {/* #i-classfa-solid-fa-spinner-fa-spin-pulsei-fast-and-feature-rich */}
...
## <i class="fa-beat fa-solid fa-heart"></i> Neat and flexible {/* #i-classfa-beat-fa-solid-fa-hearti-neat-and-flexible */}
...
## <i class="fa-solid fa-circle-info fa-beat-fade"></i> Familiarize and control {/* #i-classfa-solid-fa-circle-info-fa-beat-fadei-familiarize-and-control */}
...
## <i class="fa-solid fa-list-check"></i> Summary {/* #i-classfa-solid-fa-list-checki-summary */}
