...
###  [alacritty/alacritty][] {#comp-alacritty-alacritty}
...
###  [Aloxaf/fzf-tab][] {#comp-aloxaf-fzf-tab}
...
###  [beetbox/beets][] {#comp-beetbox-beets}
...
###  [bugaevc/wl-clipboard][] {#comp-bugaevc-wl-clipboard}
...
###  [BurntSushi/ripgrep/rg][burntSushi-ripgrep-rg] {#comp-burntsushi-ripgrep-rg}
...
###  [dbrgn/tealdeer][dbrgn-tealdeer] {#comp-dbrgn-tealdeer}
...
###  [flatpak/flatpak][] {#comp-flatpak-flatpak}
...
###  [greymd/tmux-xpanes][] {#comp-greymd-tmux-xpanes}
...
###  [mpv-player/mpv][] {#comp-mpv-player-mpv}
