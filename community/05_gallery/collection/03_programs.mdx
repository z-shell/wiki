...
## Without [for][for-syntax] syntax {/* #without-forfor-syntax-syntax */}

### GH-R: [asciinema/agg][asciinema/agg] {/* #gh-r-asciinema-agg */}

`agg` is a command-line tool for generating animated `GIF` files from asciicast v2 files produced by [asciinema terminal recorder](https://github.com/asciinema/asciinema).
...
### GH-R: [denisidoro/navi][] {/* #gh-r-denisidoronavi */}
...
### GH-R: [junegunn/fzf][] {/* #gh-r-junegunnfzf */}
...
### GH-R: [sharkdp/fd][] {/* #gh-r-sharkdpfd */}
...
### GH-R: [sharkdp/bat][] {/* #gh-r-sharkdpbat */}
...
### GH-R: [sharkdp/hexyl][] {/* #gh-r-sharkdphexyl */}
...
### GH-R: [sharkdp/hyperfine][] {/* #gh-r-sharkdphyperfine */}
...
### GH-R: [sharkdp/vivid][] {/* #gh-r-sharkdpvivid */}
...
### GH-R: [docker/compose][] {/* #gh-r-dockercompose */}
...
### GH-R: [neovim/neovim][] {/* #gh-r-neovimneovim */}
...
### GH-R: [direnv/direnv][] {/* #gh-r-direnvdirenv */}
...
### GH-R: [b4b4r07/gotcha][] {/* #gh-r-b4b4r07gotcha */}
...
### SC: [z-shell/revolver][] {/* #sc-z-shellrevolver */}

```zsh showLineNumbers
zi ice wait lucid as'program' pick'revolver'
zi light z-shell/revolver
```

### SC: [z-shell/zunit][] {/* #sc-z-shellzunit */}
...
### SC: [Osse/git-scripts/git-unique][] {/* #sc-ossegit-scriptsgit-unique */}
...
### SC: [mfaerevaag/wd][] {/* #sc-mfaerevaagwd */}
...
### SC: [z-shell/zsh-diff-so-fancy][] {/* #sc-z-shellzsh-diff-so-fancy */}
...
### SC: [obihann/archey-osx][] {/* #sc-obihannarchey-osx */}
...
### SC: [eth-p/bat-extras][] {/* #sc-eth-pbat-extras */}
...
### SC: [paulirish/git-open][] {/* #sc-paulirishgit-open */}
...
### SC: [exiftool/exiftool][] {/* #sc-exiftoolexiftool */}
...
### SC: [dylanaraps/pash][] {/* #sc-dylanarapspash */}
...
### SC: [hackerb9/lsix][] {/* #sc-hackerb9lsix */}
...
### SC: [denilsonsa/prettyping][] {/* #sc-denilsonsaprettyping */}
...
### SC: [greymd/tmux-xpanes][] {/* #sc-greymdtmux-xpanes */}
...
### SC: [DanielG/dxld-mullvad/am-i-mullvad.sh][] {/* #sc-danielgdxld-mullvadam-i-mullvadsh */}
...
### B: [abishekvashok/cmatrix][] {/* #b-abishekvashokcmatrix */}
...
### B: [tj/git-extras][] {/* #b-tjgit-extras */}
...
### B: [k4rthik/git-cal][] {/* #b-k4rthikgit-cal */}
...
### B: [aaronNG/reddio][] {/* #b-aaronngreddio */}
...
### B: [TheLocehiliosan/yadm][] {/* #b-thelocehiliosanyadm */}
...
### B: [sdushantha/farge][] {/* #b-sdushanthafarge */}
...
### B: [dylanaraps/neofetch][] {/* #b-dylanarapsneofetch */}
...
### B: [direnv/direnv][] {/* #b-direnvdirenv */}
...
### B: [sdkman/sdkman-cli][] {/* #b-sdkmansdkman-cli */}
...
### B: [asciinema/asciinema][] {/* #b-asciinemaasciinema */}
...
### RA: Rust and [Peltoche/lsd][] {/* #ra-rust-and-peltochelsd */}
...
### RA: Rust and [ogham/exa][] {/* #ra-rust-and-oghamexa */}
...
### RA: Rust and [ogham/exa][], [Peltoche/lsd][] {/* #ra-rust-and-oghamexa-peltochelsd */}
...
## With [for][for-syntax] syntax {/* #with-forfor-syntax-syntax */}
...
### GH-R: [junegunn/fzf][] + extras {/* #gh-r-junegunnfzf--extras */}
...
### GH-R: [junegunn/fzf][], [sharkdp/fd][], [sharkdp/bat][], [ogham/exa][] {/* #gh-r-junegunnfzf-sharkdpfd-sharkdpbat-oghamexa */}
...
### SC: [z-shell/revolver][], [z-shell/zunit][] {/* #sc-z-shellrevolver-z-shellzunit */}
...
### GH-R: [pnpm/pnpm](https://github.com/pnpm/pnpm) {/* #gh-r-pnpmpnpm */}
...
### GH-R: [yarnpkg/yarn][] {/* #gh-r-yarnpkgyarn */}
...
### SC: [homebrew/brew][homebrew/brew] {/* #sc-homebrewbrewhomebrewbrew */}
...
### GH-R: [dbrgn/tealdeer](https://github.com/dbrgn/tealdeer) {/* #gh-r-dbrgntealdeer */}
...
### GH-R: [koalaman/shellcheck](https://github.com/koalaman/shellcheck) {/* #gh-r-koalamanshellcheck */}
...
### GH-R: [hadolint/hadolint](https://github.com/hadolint/hadolint) {/* #gh-r-hadolinthadolint */}
...
### RA: Rust compiler environment + completions {/* #ra-rust-compiler-environment--completions */}
...
### B: [ytdl-org/youtube-dl][ytdl-org/youtube-dl] {/* #b-ytdl-orgyoutube-dlytdl-orgyoutube-dl */}
...
[b4b4r07/gotcha]: https://github.com/babarot/gotcha
[dandavison/delta]: https://github.com/dandavison/delta
[dbrgn/tealdeer]: https://github.com/tealdeer-rs/tealdeer
...
[peltoche/lsd]: https://github.com/lsd-rs/lsd
...
[thelocehiliosan/yadm]: https://github.com/yadm-dev/yadm
[tj/git-extras]: https://github.com/tj/git-extras
[vim/vim]: https://github.com/vim/vim
[yarnpkg/yarn]: https://github.com/yarnpkg/yarn
[ytdl-org/youtube-dl]: https://github.com/ytdl-org/youtube-dl
[z-shell/zsh-diff-so-fancy]: https://github.com/z-shell/zsh-diff-so-fancy
[z-shell/revolver]: https://github.com/z-shell/src/blob/d38202ee20efeec42900ce26f747a3024028845f/public/zsh/snippets/revolver
[z-shell/zunit]: https://github.com/z-shell/zunit
