...
The option needs v1.2.0 or newer, and automatic discovery plus `--no-config`
need v1.3.0; an older pinned binary prints the usage line instead. Upgrade the
pin, then see
[Project configuration](./03_project_configuration.mdx).
